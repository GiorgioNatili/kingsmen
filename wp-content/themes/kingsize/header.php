...
?>
	...
	<div id="wrapper">
		...
		<div id="menu_wrap">
          ...
          <div style="" class="contactIcons">
  					<a href="#" title="email" alt="email" style="display:inline;margin: 0 16px;vertical-align: middle;"><img src="<?php echo get_bloginfo('template_url');?>/images/email.png" title="email" alt="email"></a>
  					<a href="#" title="tel" alt="tel" style="display:inline;margin: 0 16px;vertical-align: middle;"><img src="<?php echo get_bloginfo('template_url');?>/images/tel.png" title="tel" alt="tel"></a>
  					<a href="#" title="fax" alt="fax" style="display:inline;margin: 0 16px;vertical-align: middle;"><img src="<?php echo get_bloginfo('template_url');?>/images/fax.png" title="fax" alt="fax"></a>
  				</div>
